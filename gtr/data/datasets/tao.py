...
_PREDEFINED_SPLITS_TAO = {
    "tao_train": ("tao/frames/", "tao/annotations/train.json"),
...
_PREDEFINED_SPLITS_TAOV1 = {
    "tao_train_v1": ("tao/frames/", "tao/annotations/train_v1.json"),
    "tao_val_v1": ("tao/frames/", "tao/annotations/validation_with_freeform_GTR_lvis_v1.json"),
}

for key, (image_root, json_file) in _PREDEFINED_SPLITS_TAOV1.items():
    # Since we call this dataset at GTR/train_net.py, the relative path of json file will become GTR/datasets/json_file
