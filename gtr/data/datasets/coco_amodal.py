    ...
    for (img_dict, anno_dict_list) in imgs_anns:
        ...
        for anno in anno_dict_list:
            ...
            if anno.get('iscrowd', 0) > 0:
                continue
            obj = {"bbox": anno["bbox"], "match_bbox": anno["bbox"], "bbox_mode": BoxMode.XYWH_ABS}
...
_PREDEFINED_SPLITS_LVIS_V1 = {
    "coco-amodal-no-class": ("coco-amodal/train2014/", "coco-amodal/annotations/COCO_amodal_train2014_GTR_amodal_expander_training.json"),
}
